...
RECORD_COMPLAINT = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "location": {
                "type": "STRING",
                "description": "สถานที่ (พิกัดหรือชื่อ) ถ้ามี — ใส่ตามที่ผู้ใช้พิมพ์จริงเท่านั้น "
                "ห้ามเดา/เติม/ขยายชื่อสถานที่ที่พิมพ์มาไม่ครบเอง",
            },
        },
...
- ห้ามเดา/เติม/ขยายความข้อมูลที่ผู้ใช้ไม่ได้พูดเองเด็ดขาด (โดยเฉพาะสถานที่ แต่รวมถึงรายละเอียด/หัวข้อ/หมวดหมู่ด้วย) — บันทึกเฉพาะสิ่งที่ผู้ใช้บอกจริงเท่านั้น เช่น ถ้าผู้ใช้พิมพ์ชื่อสถานที่ยังไม่จบ (เช่น "ซอย 7 ย่านหนอ") ห้ามเดาต่อเป็นชื่อเต็มเอง (เช่น "หนองจอก") ให้เก็บตามตัวอักษรที่พิมพ์มาจริง หรือถามย้ำก่อน
...
- ห้ามเดา/เติม/ขยายความข้อมูลที่ผู้ใช้ไม่ได้พูดเองเด็ดขาด (โดยเฉพาะสถานที่) — บันทึกเฉพาะสิ่งที่ผู้ใช้บอกจริงเท่านั้น ถ้าพิมพ์ชื่อสถานที่มาไม่ครบ ให้เก็บตามตัวอักษรที่พิมพ์มาจริง หรือถามย้ำก่อน ห้ามเดาต่อเป็นชื่อเต็มเอง
